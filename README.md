...
* Note that there is one small issue with the FPR source JSON: [Issue #37](https://github.com/artefactual-labs/fpr2par/issues/37). You will have to make the following fix to your fpr2.json file: [Fix](https://github.com/artefactual-labs/fpr2par/commit/aa081885776e2373f924f42b6de5326bd55641da).
